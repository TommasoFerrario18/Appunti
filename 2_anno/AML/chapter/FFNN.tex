...
reflects the parameter complexity. The regularization term is used to prevent the model from learning the noise in the training data.,
this term doesn't always appears in loss function but we can implicily apply it
