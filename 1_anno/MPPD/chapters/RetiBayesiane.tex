...
la struttura della rete. Possiamo avere una rete con una struttura:
\begin{itemize}
...
variabili. Questo algoritmo, permette nel caso di una rete Polytree, di computare
...
da zero, l'algoritmo \textbf{Markov Chain Monte Carlo} genera ogni evento tramite
modifiche casuali di un evento che lo precede nell'esecuzione.
...
senza evidenza $X_i$, condizionalmente ai valori correntemente assunti dalle
variabili che costituiscono il Markov Blanket della variabile (nodo) $X_i$.

% ! Lo deve ancora finire siamo arrivati qui
