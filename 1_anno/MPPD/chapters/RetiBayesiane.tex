...
i nodi deterministici. In questo caso è possibile, una volta identificato il
pattern, specificare un numero limitato di parametri per compilare la CPT.
...
insieme finito di intervalli.

Il problema che sorge utilizzando questo approccio è legato alla perdita di
