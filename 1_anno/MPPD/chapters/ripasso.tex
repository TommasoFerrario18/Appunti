...
\begin{definizione}[\textbf{Probabilità congiunta}]
    La \textbf{probabilità congiunta} anche detta regola del prodotto, ovvero il
    fatto che due eventi si verifichino contemporaneamente, si ottiene partendo
    dalla probabilità condizionata e dalle probabilità dei singoli eventi.
    \begin{equation}
...
Una semplificazione  della regola di Bayes, che può tornare utile in determinate
...
Consideriamo un insieme di eventi $E_1, E_2, \dots, E_n$ e tutte le possibili
