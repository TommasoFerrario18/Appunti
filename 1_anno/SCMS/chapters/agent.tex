...
\paragraph{Knowledge-based Agents}
...
\subsubsection{Russell e Norvig}
...
\begin{itemize}
    ...
    \item \textbf{Model-based reflex agents}: mantiene uno stato interno che permette
          ...
          \begin{figure}[!ht]
              ...
              \caption{Schema di un agente di tipo Model-based reflex agents}
    ...
    \item \textbf{Goal-based agents}: l'agente deve sapere quali sono le
          ...
          \begin{figure}[!ht]
              ...
              \caption{Schema di un agente di tipo Goal-based agents}
              \label{fig:GoalBased}
          \end{figure}
    \item \textbf{Utility-based agents}: in questo caso uno stesso obiettivo può
          essere raggiunto in modi diversi. Viene definita una funzione di utilità
          che che descrive il grado di soddisfazione dell'agente in base alla
          situazione in cui si trova. Ho bisogno di una funzione utilità che mi
          rappresenti il mondo in modo da guidare le scelte dell'agente in base
          alla rappresentazione e i suoi obiettivi.
          \begin{figure}[!ht]
              \centering
              \includegraphics[width=0.25\textwidth]{./img/Agenti/UtilityBasedAgent.png}
              \caption{Schema di un agente di tipo Utility-based agents}
...
Gli agenti come rappresentati da Jade sono degli oggetti dei linguaggi di
