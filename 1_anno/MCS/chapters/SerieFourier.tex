...
Possiamo creare un'approssimazione di tale funzione suddividendo l'intervallo $[0,p]$
in $n+1$ sotto-intervalli di lunghezza $\frac{p-0}{n}$ e prendendo i valori della
funzione nel punto medio di ciascun sotto-intervallo.
\begin{equation*}
    f_n = \left( f_0 = f\left(\frac{0}{n}p\right), f_1 = f\left(\frac{1}{n}p\right),
    \dots, f_n = f\left(\frac{n}{n}p\right)\right)
\end{equation*}
