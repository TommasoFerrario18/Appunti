...
Sapendo che le funzioni $\sin$ e $\cos$ sono la prima pari e la seconda dispari,
...
$$a_k = \frac{2}{p} \int_{0}^{p}f(x) \cos (\frac{2\pi k}{p}x)dx =\frac{2}{p} \int_{0}^{p}H(x)dx =\frac{2}{p} \int_{-\frac{p}{2}}^{\frac{p}{2}}H(x)dx = 0$$ 
