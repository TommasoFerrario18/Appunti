...
\begin{definizione}[\textbf{FM-index}]
    ...
    \begin{itemize}
        \item $C$ definita come:
              ...
              minori di $\sigma$. Fornisce quanti sono i suffissi che iniziano con
              un simbolo inferiore a $\sigma$ e ritorna l'ultima posizione nel SA
              dell'ultimo suffisso che inizia con un simbolo più piccolo di $\sigma$.
