...
Esistono anche altri algoirtmi per la dimostrazione di formule:
\begin{itemize}
    ...
    parziale 
    \item SAT: si riduce il problema di dimostrazione a SAT e quindi sisfruttano
    gli algoritmi esistemi per la dimostrazione.
\end{itemize}

\section{Fairness}
Un altro problema dei sistmei concorrenti è che la rappresentazione utilizzata sfrutta
