...
La \textbf{curva ROC} si costruisce eseguendo i modelli con treshold diverse incrementali,
...
modello. Generalmente si aggiungono al confronto anche \text{classificatore perfetto} (curva verde) 
