...
\end{algorithm}
\begin{osservazione}
    Un modello che non fa ipotesi preliminari per quanto riguarda l'identità del concetto target non ha alcuna base razionale per classificare eventuali nuove istanze.
\end{osservazione}
