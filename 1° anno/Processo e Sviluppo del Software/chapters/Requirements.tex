...
\begin{definizione}[\textbf{Requirements engineering}]
      ...
      \end{itemize}
      L'output di queste attività è un \textbf{documento di specifica dei requisiti} con
      tutto ciò che soddisfa il sistema. Se l'output non è un \textbf{singolo documento}
      si ha una collezione di singoli requisiti, che nel metodo agile sono
      \textbf{storie/cards} e in altri metodi un \textbf{repository centrale} con un database
...
Una volta risolte tutte le inconsistenze si definiscono le priorità per i requisiti.
