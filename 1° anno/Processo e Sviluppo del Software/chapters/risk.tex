...
\end{definizione}
\begin{definizione}[\textbf{Risck exposure}]
...
\begin{esempio}[Cut-set tree]
    ...
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.6\textwidth]{img/risk/cut-set_tree.png}
...
\begin{esempio}[Risk-exposure analysis]
    ...
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.6\textwidth]{img/risk/risk-prioritization.png}
